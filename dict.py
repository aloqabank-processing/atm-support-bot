ruDictionary = {
    ...
    '4': 'Здравствуйте! Благодарим за обращение! Передали в отдел контроля качества, в ближайшее время предоставят Вам обратную связь!',
    '5': "Другое",
    '6': "Здравствуйте! Благодарим за обращение! Передали в отдел контроля качества, к сожалению сейчас нерабочие часы. С вами свяжутся в рабочее время. Мы работаем с понедельника по пятницу, с 9:00 до 18:00.",
    '7': "🇷🇺Язык выбран",
    '8': "Отправьте фото с QR кодом",
    '9': "Нет фото",
...
uzDictionary = {
    ...
    '7': "🇺🇿Til tanlangan",
    '8': "Rasmni QR kodi bilan yuboring",
    '9': "Surat yo'q",

ru = {
    ...
    '2': 'Выберите категорию которая относится к вашей проблеме', #
    '3': 'Введите комментарий с жалобой',
    '4': 'Здравствуйте! Благодарим за обращение! Передали в отдел контроля качества, в ближайшее время предоставят Вам обратную связь! Нажмите кнопку "Далее" чтобы выйти в начальное меню и отслеживать статусы ваших заявок',
    '5': "Другое",
    '6': "Здравствуйте! Благодарим за обращение! Передали в отдел контроля качества, к сожалению сейчас нерабочие часы. С вами свяжутся в рабочее время. Мы работаем с понедельника по пятницу, с 9:00 до 18:00. Нажмите кнопку 'Далее' чтобы выйти в начальное меню и отслеживать статусы ваших заявок",
    '7': "🇷🇺Язык выбран",
    ...
    '18': "Перевыпуск карты",
    '19': "Мои заявки",
    '20': "В этом боте вы можете оставлять свои жалобы по работе банкоматов, а также свои предложения по улучшению сервиса. Выберите категорию проблемы или посмотрите статусы по оставленным заявкам", #
...
uz = {
    ...
    '20': "Ushbu botda siz bankomat ishi bo'yicha shikoyatlaringizni, shuningdek xizmatni yaxshilash bo'yicha takliflaringizni qoldirishingiz mumkin. Muammo toifasini tanlang yoki qolgan arizalar bo'yicha statuslarga qarang",
